+(function () {
    ...
    var WorkerDetailInfoTable = function (selector) {
                ...
                render: function (data, type, row, meta) {
                    if (isEmpty(data) || data === "unknown") {
                        ...
                        var _render =
                            ...
                            '<button data-target="#" data-toggle="modal" style="border:0; background:rgba(51,51,51,0.425); color:#fbeed5; vertical-align: middle" onclick="click_issue_key('
