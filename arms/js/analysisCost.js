...
//                    }
//                };
//             console.log(버전별_요구사항별_단가)
//            for (var pds_version_link in 요구사항별_키목록) { // 버전 순회
//                for (var req_link in 요구사항별_키목록[pds_version_link]) { // 요구사항 순회
//                    var 데이터 = 요구사항별_키목록[pds_version_link][req_link]; // 요구사항 하위 이슈 키들
//                    if (Array.isArray(데이터)) {
//                        var 요구사항별_단가 = 버전별_요구사항별_단가[pds_version_link]; // 요구사항 단가 맵
//                        if (요구사항별_단가 && 요구사항별_단가[req_link]) {
//                            var 단가 = 요구사항별_단가[req_link];
//                            데이터.forEach(function(item) {
//                            item.cost = 단가 / 데이터.length;  // 리스트 크기로 나눠 각각에 넣기
//                            });
//                        }
//                    }
//                }
