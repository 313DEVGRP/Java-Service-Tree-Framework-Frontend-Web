...
!function(t, n) {
            ...
            if (null != e) {
                ...
                try {
                    ...
                    0 === n) {
                        ...
                        for (; !(l = (r = a.call(e)).done) && (u.push(r.value),
                        u.length !== n); l = !0)
                            ;
                } catch (t) {
                    s = !0,
    ...
    function h(t) {
        ...
        return 2 !== t.length ? (n = c,
        e = (n,e)=>c(t(n), e),
        r = (n,e)=>t(n) - e) : (n = t === c || t === f ? t : p,
        e = t,
        r = t),
        {
            left: i,
    ...
    function x(t, n, e) {
        ...
        let u, l, s;
        return i < 0 ? (s = Math.pow(10, -i) / o,
        u = Math.round(t * s),
        l = Math.round(n * s),
        u / s < t && ++u,
        l / s > n && --l,
        s = -s) : (s = Math.pow(10, i) * o,
        u = Math.round(t / s),
        l = Math.round(n / s),
        u * s < t && ++u,
        l * s > n && --l),
        l < u && .5 <= e && e < 2 ? x(t, n, 2 * e) : [u, l, s]
    }
    function M(t, n, e) {
    ...
    function O(t, n) {
        ...
        function h(h) {
            ...
            h !== w && (_ = _.transition(h),
            x = x.transition(h),
            S = S.transition(h),
            k = k.transition(h),
            M = M.transition(h).attr("opacity", F).attr("transform", (function(t) {
    ...
    function B() {
        var t, n, e = q().unknown(void 0), r = e.domain, i = e.range, a = 0, o = 1, u = !1, l = 0, s = 0, c = .5;
        function f() {
            var e = r().length
              , f = o < a
              , h = f ? o : a
        ...
        e.padding = function(t) {
            return arguments.length ? (l = Math.min(1, s = +t),
            f()) : l
        }
        ,
    ...
    function ht(t) {
        ...
        (n = et.exec(t)) ? (e = n[1].length,
        n = parseInt(n[1], 16),
        6 === e ? pt(n) : 3 === e ? new mt(n >> 8 & 15 | n >> 4 & 240,n >> 4 & 15 | 240 & n,(15 & n) << 4 | 15 & n,1) : 8 === e ? gt(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (255 & n) / 255) : 4 === e ? gt(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, ((15 & n) << 4 | 15 & n) / 255) : null) : (n = rt.exec(t)) ? new mt(n[1],n[2],n[3],1) : (n = it.exec(t)) ? new mt(255 * n[1] / 100,255 * n[2] / 100,255 * n[3] / 100,1) : (n = at.exec(t)) ? gt(n[1], n[2], n[3], n[4]) : (n = ot.exec(t)) ? gt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = ut.exec(t)) ? xt(n[1], n[2] / 100, n[3] / 100, 1) : (n = lt.exec(t)) ? xt(n[1], n[2] / 100, n[3] / 100, n[4]) : st.hasOwnProperty(t) ? pt(st[t]) : "transparent" === t ? new mt(NaN,NaN,NaN,0) : null
    }
    function pt(t) {
    ...
    function dt(t, n, e, r) {
        return 1 === arguments.length ? ((i = t)instanceof Z || (i = ht(i)),
        i ? new mt((i = i.rgb()).r,i.g,i.b,i.opacity) : new mt) : new mt(t,n,e,null == r ? 1 : r);
        var i
    }
    function mt(t, n, e, r) {
        this.r = +t,
    ...
    function Mt(t) {
        ...
        var n = (t = t.rgb()).r / 255
          ...
          , u = a - i
          , l = (a + i) / 2;
        return u ? (o = n === a ? (e - r) / u + 6 * (e < r) : e === a ? (r - n) / u + 2 : (n - e) / u + 4,
        u /= l < .5 ? a + i : 2 - a - i,
        o *= 60) : u = l > 0 && l < 1 ? 0 : o,
        new At(o,u,l,t.opacity)
    }
    function At(t, n, e, r) {
        this.h = +t,
        this.s = +n,
    ...
    W(mt, dt, G(Z, {
        brighter(t) {
            return t = null == t ? J : Math.pow(J, t),
            new mt(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        darker(t) {
            return t = null == t ? Q : Math.pow(Q, t),
            new mt(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        rgb() {
            return this
    ...
    ,
    function(t) {
        var n, e, r = t.length, i = new Array(r), a = new Array(r), o = new Array(r);
        for (n = 0; n < r; ++n)
            e = dt(t[n]),
            i[n] = e.r || 0,
            a[n] = e.g || 0,
    ...
    function jt(t, n) {
        var e, r, i, a = Ot.lastIndex = Pt.lastIndex = 0, o = -1, u = [], l = [];
        for (t += "",
        n += ""; (e = Ot.exec(t)) && (r = Pt.exec(n)); )
            (i = r.index) > a && (i = n.slice(a, i),
            u[o] ? u[o] += i : u[++o] = i),
            (e = e[0]) === (r = r[0]) ? u[o] ? u[o] += r : u[++o] = r : (u[++o] = null,
            l.push({
                i: o,
                x: Rt(e, r)
            })),
    ...
    function $t(t, n) {
        var e, r, i = typeof n;
        return null == n || "boolean" === i ? Tt(n) : ("number" === i ? Rt : "string" === i ? (e = ht(n)) ? (n = e,
        zt) : jt : n instanceof ht ? zt : n instanceof Date ? Ut : (r = n,
        !ArrayBuffer.isView(r) || r instanceof DataView ? Array.isArray(n) ? Lt : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? Yt : Rt : Ht))(t, n)
    }
    function It(t, n) {
        return t = +t,
        n = +n,
    ...
    var Gt = Wt((function(t) {
      ...
      , Zt = Wt((function(t) {
        return null == t ? Xt : (qt || (qt = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        qt.setAttribute("transform", t),
        (t = qt.transform.baseVal.consolidate()) ? Vt((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Xt)
    }
    ), ", ", ")", ")");
    function Qt(t) {
        return +t
    ...
    function an() {
        var t, n, e, r, i, a, o = Jt, u = Jt, l = $t, s = Kt;
        function c() {
        ...
        ,
        f.domain = function(t) {
            return arguments.length ? (o = Array.from(t, Qt),
            c()) : o.slice()
        }
        ,
        f.range = function(t) {
        ...
        ,
        f.clamp = function(t) {
            return arguments.length ? (s = !!t || Kt,
            c()) : s !== Kt
        }
        ,
    ...
    var mn, vn, yn, bn = Array.prototype.map, wn = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function _n(t) {
        var n, e, r = void 0 === t.grouping || void 0 === t.thousands ? dn : (n = bn.call(t.grouping, Number),
        e = t.thousands + "",
        function(t, r) {
            for (var i = t.length, a = [], o = 0, u = n[0], l = 0; i > 0 && u > 0 && (l + u + 1 > r && (u = Math.max(1, r - l)),
            a.push(t.substring(i -= u, i + u)),
            !((l += u + 1) > r)); )
                u = n[o = (o + 1) % n.length];
            return a.reverse().join(e)
        }
        ), i = void 0 === t.currency ? "" : t.currency[0] + "", a = void 0 === t.currency ? "" : t.currency[1] + "", o = void 0 === t.decimal ? "." : t.decimal + "", u = void 0 === t.numerals ? dn : function(t) {
            return function(n) {
        ...
        }(bn.call(t.numerals, String)), l = void 0 === t.percent ? "%" : t.percent + "", s = void 0 === t.minus ? "−" : t.minus + "", c = void 0 === t.nan ? "NaN" : t.nan + "";
        function f(t) {
            var n = (t = fn(t)).fill
              , e = t.align
              , f = t.sign
            ...
            function M(t) {
                ...
                switch (d && p && (t = r(k + t, k.length ? g - M.length : 1 / 0),
                k = ""),
                e) {
                case "<":
                    t = h + t + M + k;
            ...
            return m = void 0 === m ? 6 : /[gprs]/.test(y) ? Math.max(1, Math.min(21, m)) : Math.max(0, Math.min(20, m)),
            M.toString = function() {
                return t + ""
            }
            ,
    ...
    function Mn(t) {
        ...
        t.nice = function(e) {
            null == e && (e = 10);
            var r, i, a = n(), o = 0, u = a.length - 1, l = a[o], s = a[u], c = 10;
            for (s < l && (i = l,
            l = s,
            s = i,
            i = o,
    ...
    Tn.every = t=>(t = Math.floor(t),
    isFinite(t) && t > 0 ? t > 1 ? Cn((n=>{
    ...
    function ur(t, n) {
        return t = or(t),
        Se(Gn.count(le(t), t) + (4 === le(t).getDay()), n, 2)
    }
    function lr(t) {
        return t.getDay()
    }
    ...
    function Cr(t, n) {
        return t = kr(t),
        Se(re.count(se(t), t) + (4 === se(t).getUTCDay()), n, 2)
    }
    function Tr(t) {
        return t.getUTCDay()
    }
    ...
    function Ir() {
        var t = Mn(function() {
            var t, n, e, r, i, a = 0, o = 1, u = Kt, l = !1;
            function s(n) {
                return null == n || isNaN(n = +n) ? i : u(0 === e ? .5 : (n = (r(n) - t) * e,
                l ? Math.max(0, Math.min(1, n)) : n))
            }
            function c(t) {
                return function(n) {
                    var e, r;
        ...
        return t.copy = function() {
            return n = t,
            Ir().domain(n.domain()).interpolator(n.interpolator()).clamp(n.clamp()).unknown(n.unknown());
            var n
        }
        ,
        $.apply(t, arguments)
    ...
    !function(t) {
        ye = function(t) {
            var n = t.dateTime
              ...
              , _ = {
                a: function(t, n, e) {
                    ...
                    return r ? (t.w = g.get(r[0].toLowerCase()),
                    e + r[0].length) : -1
                },
                A: function(t, n, e) {
            ...
            function x(t, n) {
                return function(e) {
                    var r, i, a, o = [], u = -1, l = 0, s = t.length;
                    for (e instanceof Date || (e = new Date(+e)); ++u < s; )
                        37 === t.charCodeAt(u) && (o.push(t.slice(l, u)),
                        null != (i = _e[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0",
                        (a = n[r]) && (r = a(e, i)),
                        o.push(r),
                        l = u + 1);
                    return o.push(t.slice(l, u)),
                    o.join("")
                }
            }
            function M(t, n) {
                return function(e) {
                    var r, i, a = ve(1900, void 0, 1);
                    ...
                    "V"in a) {
                        if (a.V < 1 || a.V > 53)
                            return null;
                        "w"in a || (a.w = 1),
                        "Z"in a ? (i = (r = me(ve(a.y, 0, 1))).getUTCDay(),
                        r = i > 4 || 0 === i ? te.ceil(r) : te(r),
                        r = $n.offset(r, 7 * (a.V - 1)),
                        a.y = r.getUTCFullYear(),
                        a.m = r.getUTCMonth(),
                        a.d = r.getUTCDate() + (a.w + 6) % 7) : (i = (r = de(ve(a.y, 0, 1))).getDay(),
                        r = i > 4 || 0 === i ? Xn.ceil(r) : Xn(r),
                        r = jn.offset(r, 7 * (a.V - 1)),
                        a.y = r.getFullYear(),
                        a.m = r.getMonth(),
                        a.d = r.getDate() + (a.w + 6) % 7)
                    } else
                        ("W"in a || "U"in a) && ("w"in a || (a.w = "u"in a ? a.u % 7 : "W"in a ? 1 : 0),
                        i = "Z"in a ? me(ve(a.y, 0, 1)).getUTCDay() : de(ve(a.y, 0, 1)).getDay(),
                        a.m = 0,
                        a.d = "W"in a ? (a.w + 6) % 7 + 7 * a.W - (i + 5) % 7 : a.w + 7 * a.U - (i + 6) % 7);
            ...
            function A(t, n, e, r) {
                for (var i, a, o = 0, u = n.length, l = e.length; o < u; ) {
                    ...
                    if (37 === (i = n.charCodeAt(o++))) {
                        if (i = n.charAt(o++),
                        !(a = _[i in _e ? n.charAt(o++) : i]) || (r = a(t, e, r)) < 0)
                            return -1
    ...
    function si(t, n, e, r, i, a) {
        for (var o, u = 0, l = n.length, s = a.length; u < s; ++u)
            (o = n[u]) ? (o.__data__ = a[u],
            r[u] = o) : e[u] = new li(t,a[u]);
        for (; u < l; ++u)
            (o = n[u]) && (i[u] = o)
    }
    function ci(t, n, e, r, i, a, o) {
        var u, l, s, c = new Map, f = n.length, h = a.length, p = new Array(f);
        for (u = 0; u < f; ++u)
            (l = n[u]) && (p[u] = s = o.call(l, l.__data__, u, n) + "",
            c.has(s) ? i[u] = l : c.set(s, l));
        for (u = 0; u < h; ++u)
            s = o.call(t, a[u], u, a) + "",
            (l = c.get(s)) ? (r[u] = l,
            l.__data__ = a[u],
            c.delete(s)) : e[u] = new li(t,a[u]);
        for (u = 0; u < f; ++u)
    ...
    function Gi(t, n, e) {
        return function() {
            var r, i = this.__on, a = function(t) {
                return function(n) {
    ...
    ta.prototype = na.prototype = {
        ...
        select: function(t) {
            ...
            for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
                for (var a, o, u = n[i], l = u.length, s = r[i] = new Array(l), c = 0; c < l; ++c)
                    (a = u[c]) && (o = t.call(a, a.__data__, c, u)) && ("__data__"in a && (o.__data__ = a.__data__),
                    s[c] = o);
        ...
        selectAll: function(t) {
            ...
            for (var n = this._groups, e = n.length, r = [], i = [], a = 0; a < e; ++a)
                for (var o, u = n[a], l = u.length, s = 0; s < l; ++s)
                    (o = u[s]) && (r.push(t.call(o, o.__data__, s, u)),
                    i.push(o));
            return new ta(r,i)
        },
        ...
        data: function(t, n) {
            ...
            var e, r = n ? ci : si, i = this._parents, a = this._groups;
    ...
    function _a(t, n, e, r, i, a) {
        for (var o, u = 0, l = n.length, s = a.length; u < s; ++u)
            (o = n[u]) ? (o.__data__ = a[u],
            r[u] = o) : e[u] = new ba(t,a[u]);
        for (; u < l; ++u)
            (o = n[u]) && (i[u] = o)
    }
    function xa(t, n, e, r, i, a, o) {
        var u, l, s, c = {}, f = n.length, h = a.length, p = new Array(f);
        for (u = 0; u < f; ++u)
            (l = n[u]) && (p[u] = s = wa + o.call(l, l.__data__, u, n),
            s in c ? i[u] = l : c[s] = l);
        for (u = 0; u < h; ++u)
            (l = c[s = wa + o.call(t, a[u], u, a)]) ? (r[u] = l,
            l.__data__ = a[u],
            c[s] = null) : e[u] = new ba(t,a[u]);
        for (u = 0; u < f; ++u)
            (l = n[u]) && c[p[u]] === l && (i[u] = l)
    }
    function Ma(t, n) {
    ...
    function mo() {
        ...
        function l(t) {
            ...
            a && (o = a.createSVGPoint(),
            r.appendChild(i))
        }
        l.show = function() {
            var i = Array.prototype.slice.call(arguments);
            i[i.length - 1]instanceof SVGElement && (u = i.pop());
            var a, o = e.apply(this, i), f = n.apply(this, i), p = t.apply(this, i), g = h(), d = c.length, m = document.documentElement.scrollTop || r.scrollTop, v = document.documentElement.scrollLeft || r.scrollLeft;
            for (g.html(o).style("opacity", 1).style("pointer-events", "all"); d--; )
                g.classed(c[d], !1);
            return a = s.get(p).apply(this),
            g.classed(p, !0).style("top", a.top + f[0] + m + "px").style("left", a.left + f[1] + v + "px"),
            l
        }
        ,
        l.hide = function() {
            return h().style("opacity", 0).style("pointer-events", "none"),
            l
        }
        ,
        l.attr = function(t, n) {
            ...
            return po.prototype.attr.apply(h(), e),
            l
        }
        ,
        l.style = function(t, n) {
            if (arguments.length < 2 && "string" == typeof t)
                return h().style(t);
            var e = Array.prototype.slice.call(arguments);
            return po.prototype.style.apply(h(), e),
            l
        }
        ,
        l.direction = function(n) {
            return arguments.length ? (t = null == n ? n : g(n),
            l) : t
        }
        ,
        l.offset = function(t) {
            return arguments.length ? (n = null == t ? t : g(t),
            l) : n
        }
        ,
        l.html = function(t) {
            return arguments.length ? (e = null == t ? t : g(t),
            l) : e
        }
        ,
        l.rootElement = function(t) {
            return arguments.length ? (r = null == t ? t : g(t),
            l) : r
        }
        ,
        l.destroy = function() {
    ...
    ho.prototype = po.prototype = {
        ...
        data: function(t, n) {
            if (!t)
                ...
                g;
            var e, r = n ? xa : _a, i = this._parents, a = this._groups;
            "function" != typeof t && (e = t,
            t = function() {
                return e
            }
    ...
    s({
        ...
        update: function(t) {
            for (var n, e, r = t.el.textContent, i = Math.round(r.length * t.maxWidth / t.el.getBBox().width * 1.2); --i && t.maxWidth / t.el.getBBox().width < 1; )
                t.el.textContent = (e = i,
                (n = r).length <= e ? n : n.substring(0, 2 * e / 3) + "..." + n.substring(n.length - e / 3, n.length))
        }
    });
    ...
    Eu.prototype = {
        ...
        data: function(t, n) {
            ...
            var e, r = n ? qo : Io, i = this._parents, a = this._groups;
            "function" != typeof t && (e = t,
            t = function() {
                return e
            }
    ...
    function Ru(t, n) {
        ...
        var e = function(t) {
            ...
            "object" == Hu(t) && (gl(t.r) && gl(t.g) && gl(t.b) ? (l = t.r,
            s = t.g,
            c = t.b,
            n = {
                r: 255 * rl(l, 255),
            ...
            o = !0,
            u = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : gl(t.h) && gl(t.s) && gl(t.v) ? (r = ul(t.s),
            i = ul(t.v),
            n = function(t, n, e) {
                t = 6 * rl(t, 360),
                n = rl(n, 100),
            ...
            o = !0,
            u = "hsv") : gl(t.h) && gl(t.s) && gl(t.l) && (r = ul(t.s),
            a = ul(t.l),
            n = function(t, n, e) {
                var r, i, a;
                function o(t, n, e) {
    ...
    function Yu(t, n, e) {
        ...
        n = rl(n, 255),
        e = rl(e, 255);
        var r, i, a = Math.max(t, n, e), o = Math.min(t, n, e), u = (a + o) / 2;
        if (a == o)
            r = i = 0;
        else {
            var l = a - o;
            switch (i = u > .5 ? l / (2 - a - o) : l / (a + o),
            a) {
            case t:
                r = (n - e) / l + (n < e ? 6 : 0);
                break;
    ...
    function Ou(t, n, e) {
        ...
        n = rl(n, 255),
        e = rl(e, 255);
        var r, i, a = Math.max(t, n, e), o = Math.min(t, n, e), u = a, l = a - o;
        if (i = 0 === a ? 0 : l / a,
        a == o)
            r = 0;
        else {
    ...
    function Xu(t, n) {
        n = 0 === n ? 0 : n || 10;
        var e = Ru(t).toRgb();
        return e.r = Math.max(0, Math.min(255, e.r - Math.round(-n / 100 * 255))),
    ...
    Ru.prototype = {
        ...
        getLuminance: function() {
            ...
            n = r.g / 255,
            e = r.b / 255,
            .2126 * (t <= .03928 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4)) + .7152 * (n <= .03928 ? n / 12.92 : Math.pow((n + .055) / 1.055, 2.4)) + .0722 * (e <= .03928 ? e / 12.92 : Math.pow((e + .055) / 1.055, 2.4))
        },
        setAlpha: function(t) {
            return this._a = el(t),
            this._roundA = Math.round(100 * this._a) / 100,
        ...
        toString: function(t) {
            ...
            return n || !r || "hex" !== t && "hex6" !== t && "hex3" !== t && "hex4" !== t && "hex8" !== t && "name" !== t ? ("rgb" === t && (e = this.toRgbString()),
    ...
    Ru.mostReadable = function(t, n, e) {
        var r, i, a, o, u = null, l = 0;
        i = (e = e || {}).includeFallbackColors,
        a = e.level,
        o = e.size;
        for (var s = 0; s < n.length; s++)
            (r = Ru.readability(t, n[s])) > l && (l = r,
            u = Ru(n[s]));
        return Ru.isReadable(t, u, {
            level: a,
            size: o
        }) || !i ? u : (e.includeFallbackColors = !1,
        Ru.mostReadable(t, ["#fff", "#000"], e))
    }
    ;
    var tl = Ru.names = {
        aliceblue: "f0f8ff",
    ...
    function rl(t, n) {
        ...
        return t = Math.min(n, Math.max(0, parseFloat(t))),
    ...
    var cl, fl, hl, pl = (fl = "[\\s|\\(]+(" + (cl = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + cl + ")[,|\\s]+(" + cl + ")\\s*\\)?",
    hl = "[\\s|\\(]+(" + cl + ")[,|\\s]+(" + cl + ")[,|\\s]+(" + cl + ")[,|\\s]+(" + cl + ")\\s*\\)?",
    {
    ...
    var Sl, kl, Cl = 0, Tl = 0, Dl = 0, Nl = 1e3, zl = 0, El = 0, Fl = 0, Hl = "object" == typeof performance && performance.now ? performance : Date, Ll = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
        setTimeout(t, 17)
    }
    ;
    function Ul() {
    ...
    function $l(t) {
        Cl || (Tl && (Tl = clearTimeout(Tl)),
        t - El > 24 ? (t < 1 / 0 && (Tl = setTimeout(Pl, t - Hl.now() - Fl)),
        Dl && (Dl = clearInterval(Dl))) : (Dl || (zl = Hl.now(),
        Dl = setInterval(jl, Nl)),
        Cl = 1,
        Ll(Pl)))
    }
    function Il(t, n, e) {
    ...
    Yl.prototype = Ol.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            this._next || kl === this || (kl ? kl._next = this : Sl = this,
            kl = this),
            this._call = t,
            this._time = e,
            $l()
        ...
        !function(t, n, e) {
            ...
            function u(n) {
                ...
                1), a = -1, o = r.length; ++a < o; )
                    r[a].call(t, i);
                e.state === Ql && (e.on.call("end", t, t.__data__, e.index, e.group),
                l())
            }
            function l() {
                for (var r in e.state = Jl,
                e.timer.stop(),
                delete i[n],
                i)
                    return;
    ...
    function rs(t, n) {
        ...
        if (a) {
            ...
            a)
                (e = a[i]).name === n ? (r = e.state > Wl && e.state < Ql,
                e.state = Jl,
                e.timer.stop(),
    ...
    function us(t, n) {
        var e;
        return ("number" == typeof n ? Rt : n instanceof ht ? zt : (e = ht(n)) ? (n = e,
        zt) : jt)(t, n)
    }
    function ls(t) {
        return function() {
    ...
    function hs(t, n, e) {
        ...
        return function() {
            var o, u, l = e(this);
            if (null != l)
                return (o = this.getAttribute(t)) === (u = l + "") ? null : o === r && u === i ? a : (i = u,
                a = n(r = o, l));
            this.removeAttribute(t)
        }
    }
    function ps(t, n, e) {
        ...
        return function() {
            var o, u, l = e(this);
            if (null != l)
                return (o = this.getAttributeNS(t.space, t.local)) === (u = l + "") ? null : o === r && u === i ? a : (i = u,
                a = n(r = o, l));
            this.removeAttributeNS(t.space, t.local)
        }
    }
    ...
    function Js() {
        return function(t) {
            var n, e = Gs, r = Ws, i = Zs, a = !0, o = bl("start", "brush", "end"), u = 6;
            function l(n) {
            ...
            function h(e) {
                if ((!n || e.touches) && r.apply(this, arguments)) {
                    var i, o, u, l, f, h, p, g, d, m, v, y = this, b = e.target.__data__.type, w = "selection" === (a && e.metaKey ? b = "overlay" : b) ? zs : a && e.altKey ? Hs : Fs, _ = t === js ? null : Bs[b], x = t === Ps ? null : Xs[b], M = Qs(y), A = M.extent, S = M.selection, k = A[0][0], C = A[0][1], T = A[1][0], D = A[1][1], N = 0, z = 0, E = _ && x && a && e.shiftKey, F = Array.from(e.touches || [e], (t=>{
                        const n = t.identifier;
                        return (t = ra(t, y)).point0 = t.slice(),
                        t.identifier = n,
                        t
                    }
                    ));
                    ...
                    if (e.touches)
                        ...
                        function(t) {
                            ...
                            "onselectstart"in n ? e.on("selectstart.drag", Al, Ml) : (n.__noselect = n.style.MozUserSelect,
                ...
                function O(t) {
                    ...
                    case zs:
                        ...
                        break;
                    case Fs:
                        F[1] ? (_ && (o = Us(k, Rs(T, F[0][0])),
                        h = Us(k, Rs(T, F[1][0])),
                        _ = 1),
                        x && (l = Us(C, Rs(D, F[0][1])),
                        g = Us(C, Rs(D, F[1][1])),
                        x = 1)) : (_ < 0 ? (N = Us(k - i, Rs(T - i, N)),
                        o = i + N,
                        h = f) : _ > 0 && (N = Us(k - f, Rs(T - f, N)),
                        o = i,
                        h = f + N),
                        x < 0 ? (z = Us(C - u, Rs(D - u, z)),
                        l = u + z,
                        g = p) : x > 0 && (z = Us(C - p, Rs(D - p, z)),
                        l = u,
                        g = p + z));
                        break;
                    case Hs:
                    ...
                    o = h,
                    h = r,
                    b in Is && U.attr("cursor", $s[b = Is[b]])),
                    g < l && (x *= -1,
                    r = u,
                    u = p,
                    p = r,
                    ...
                    l = g,
                    g = r,
                    b in qs && U.attr("cursor", $s[b = qs[b]])),
                    M.selection && (S = M.selection),
                    m && (o = S[0][0],
                    h = S[1][0]),
                    v && (l = S[0][1],
                    g = S[1][1]),
                    S[0][0] === o && S[0][1] === l && S[1][0] === h && S[1][1] === g || (M.selection = [[o, l], [h, g]],
                    s.call(y),
                    H.brush(t, w.name))
                }
                function P(t) {
                ...
                function j(t) {
                    ...
                    case 18:
                        ...
                        break;
                    case 32:
                        w !== Fs && w !== Hs || (_ < 0 ? f = h - N : _ > 0 && (i = o - N),
                        x < 0 ? p = g - z : x > 0 && (u = l - z),
                        w = Es,
                        U.attr("cursor", $s.selection),
                        O(t));
                        break;
                    default:
                        return
                ...
                function $(t) {
                    ...
                    case 16:
                        ...
                        break;
                    case 18:
                        w === Hs && (_ < 0 ? f = h : _ > 0 && (i = o),
                        x < 0 ? p = g : x > 0 && (u = l),
                        w = Fs,
                        O(t));
                        break;
                    case 32:
                        w === Es && (t.altKey ? (_ && (f = h - N * _,
                        i = o + N * _),
                        x && (p = g - z * x,
                        u = l + z * x),
                        w = Hs) : (_ < 0 ? f = h : _ > 0 && (i = o),
            ...
            function d() {
                ...
                return n.extent = Os(e.apply(this, arguments)),
                n.dim = t,
                n
            }
            ...
            l.extent = function(t) {
                return arguments.length ? (e = "function" == typeof t ? t : Ts(Os(t)),
                l) : e
            }
            ,
            l.filter = function(t) {
    ...
    return s({
        ...
        methods: {
            ...
            overviewDomain: function(t, n) {
                return t.enableOverview ? n ? (t.overviewArea.domainRange(n),
                this) : t.overviewArea.domainRange() : null
            },
            refresh: function(t) {
                return t._rerender(),
                this
        ...
        init: function(t, n) {
            var e, r, i = ea(t).attr("class", "timelines-chart");
            n.svg = i.append("svg"),
            ...
            function() {
                ...
                n.svg.on("zoomScent", (function(t) {
                    ...
                    n.overviewArea && e && ((e[0] < n.overviewArea.domainRange()[0] || e[1] > n.overviewArea.domainRange()[1]) && n.overviewArea.domainRange([new Date(Math.min(e[0], n.overviewArea.domainRange()[0])), new Date(Math.max(e[1], n.overviewArea.domainRange()[1]))]),
            ...
            n.groupTooltip = mo().attr("class", "chart-tooltip group-tooltip").direction("w").offset([0, 0]).html((function(t, e) {
                ...
                return n.groupTooltip.offset([i, -r]),
                e.group
            }
            )),
            ...
            n.lineTooltip = mo().attr("class", "chart-tooltip line-tooltip").direction("e").offset([0, 0]).html((function(t, e) {
                ...
                return n.lineTooltip.offset([0, r]),
                e.label
            }
            )),
            ...
            n.svg.on("zoom", (function(t) {
                ...
                a && (n._rerender(),
                n.onZoom && n.onZoom(n.zoomX, n.zoomY)))
            }
            )),
            n.svg.on("resetZoom", (function() {
                var t = n.zoomX
                  ...
                  , i = [null, null];
                (t[0] < r[0] || t[1] > r[1] || e[0] != i[0] || e[1] != r[1]) && (n.zoomX = [new Date(Math.min(t[0], r[0])), new Date(Math.max(t[1], r[1]))],
                n.zoomY = i,
                n.svg.dispatch("zoomScent", {
                    detail: {
                        zoomX: n.zoomX,
        ...
        update: function(n) {
            !function() {
                ...
                for (var i = function(t) {
                    ...
                    if (e.length - r[0] >= r[1])
                        return i.lines = e.slice(r[0], r[1] + r[0]),
                        n.structData.push(i),
                        r[1] = 0,
                        "break";
                    r[0] > 0 ? (i.lines = e.slice(r[0]),
                    r[0] = 0) : i.lines = e,
                    n.structData.push(i),
                    r[1] -= i.lines.length
